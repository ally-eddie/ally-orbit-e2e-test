...
test.describe('取消轉運', () => {
    test('可以取消轉運', async ({ page, context }) => {
    ...
    await deliveryNoticePage.locator('button:has-text("取消轉運")').click();                   
    ...
    await deliveryNoticePage.locator('div.MuiDialog-container button:has-text("確認取消轉運")').click();    
